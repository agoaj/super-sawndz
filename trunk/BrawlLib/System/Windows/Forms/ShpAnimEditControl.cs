...
namespace System.Windows.Forms
{
    public class ShpAnimEditControl : UserControl
    {
        ...
        private void RefreshPage()
        {
            if (_target != null)
            {
                ...
                _currentValue = _target.Keyframes.GetFrameValue(KeyFrameMode.ScaleX, _currentPage);
                numScale.Value = _currentValue;
                UpdateBox(0);
        ...
        private void InitializeComponent()
        {
            ...
            this.numScale.Location = new System.Drawing.Point(97, 32);
            ...
            this.listKeyframes.Size = new System.Drawing.Size(294, 115);
    ...
    public class FloatKeyframe
    {
        ...
        {
            return String.Format("[{0}] {1}", Index + 1, Value);
        }
    }
}
